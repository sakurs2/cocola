...
// collapsible dev panel for the Bearer token (kept so a developer can drive
// the real backend before a proper auth flow exists). The session id is
// auto-generated by the runtime and no longer surfaced here.
function TopBar() {
  const { token, setToken, sandbox } = useCocola();
