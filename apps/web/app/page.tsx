...
// history / folders) and a main column with a slim top bar (model pill +
// sandbox status) over the Thread. The runtime owns message state and the SSE
...
// Slim top bar: model pill (static placeholder) + sandbox status. The session
// id is auto-generated by the runtime and identity is fixed to the dev-user, so
// there are no developer inputs to surface here.
function TopBar() {
