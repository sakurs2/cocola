          ...
          <Sheet.Dialog>
            ...
            <Sheet.Header>
              <span className="flex items-center gap-3">
                <span className="bg-danger/10 text-danger flex size-10 shrink-0 items-center justify-center rounded-2xl">
            ...
            <Sheet.Footer className="gap-2">
              ...
              <Button isPending={busy} variant="danger" onPress={onConfirm}>
                {confirmLabel}
              </Button>
            </Sheet.Footer>
          </Sheet.Dialog>
