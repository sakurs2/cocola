...
func TestSessionEntrypoint(t *testing.T) {
	...
	for _, want := range []string{
		"mkdir -p '/session/workspace' '/session/runtime/claude' '/session/runtime/cocola' '/session/runtime/browser' " + localDirs,
		"chown 'cocola':'cocola' '/session/workspace' '/session/runtime/claude' '/session/runtime/cocola' '/session/runtime/browser' " + localDirs,
