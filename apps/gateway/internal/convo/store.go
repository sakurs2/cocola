...
type Part struct {
	...
	// plan: a durable, versioned plan generated by a planning-only run.
	PlanID              string `json:"planId,omitempty"`
	Version             int    `json:"version,omitempty"`
	PlanContentMarkdown string `json:"contentMarkdown,omitempty"`

	// question: a durable user-input request. Options and the accepted answer
	// contain display-safe values only; runtime prompts and credentials never
	// enter this Part.
	QuestionID      string           `json:"questionId,omitempty"`
	Question        string           `json:"question,omitempty"`
	QuestionOptions []QuestionOption `json:"options,omitempty"`
	QuestionAnswer  *QuestionAnswer  `json:"answer,omitempty"`

	// run-summary: authoritative terminal metadata derived from
	// conversation_runs. ErrorCode is a safe code, never a raw error.
