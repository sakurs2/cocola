...
export COCOLA_AGENT_RUNTIME_DEFAULT_ID="${COCOLA_AGENT_RUNTIME_DEFAULT_ID:-claude-code}"
export COCOLA_AGENT_RUNTIME_PICKER_ENABLED="${COCOLA_AGENT_RUNTIME_PICKER_ENABLED:-false}"
export COCOLA_AGENT_MAX_TURNS="${COCOLA_AGENT_MAX_TURNS:-200}"
export COCOLA_AGENT_TOOL_STEP_TIMEOUT_SECS="${COCOLA_AGENT_TOOL_STEP_TIMEOUT_SECS:-3600}"
