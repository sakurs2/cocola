...
_NATIVE_PLAN_MODE_INSTRUCTIONS = (
    ...
    "plan as the only tool call and wait for it to succeed. Never use Bash, mkdir, touch, Write, "
    "Edit, or NotebookEdit to create or manage the native plan file or its directory; "
    "cocola_update_plan owns both directory creation and persistence. Then call ToolSearch with "
    "query "
